...
GSTREAMERDEPLOY=/Library/Frameworks/GStreamerDeploy.framework/Versions/1.0
...
cplib() {
    cp $GSTREAMERDEPLOY/lib/$1 gstreamer/lib/$1
}
...
cp $GSTREAMERDEPLOY/libexec/gstreamer-1.0/gst-plugin-scanner gstreamer/libexec/gstreamer-1.0
